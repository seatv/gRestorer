...
# Import stubs from __init__.py instead of mmengine
from . import kaiming_init, constant_init, _BatchNorm
...
def build_module(module: Union[dict, nn.Module], builder, *args,
                 **kwargs) -> Any:
